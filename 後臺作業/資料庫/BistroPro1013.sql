...
---商品----------------------------------------------------------------------------------------------------------------------------
	...
	CREATE TABLE ProductRatings (
			rating_id INT PRIMARY KEY IDENTITY(1,1),					-- 自動生成的評價ID
	...
	INSERT INTO ProductRatings (product_id, total_rating, rating_count, average_rating, highest_rating, lowest_rating, last_rating_date)
		VALUES
			('P001', 20, 4, 5.00, 5, 4, '2024-10-09'),  -- 牛排
			('P002', 16, 4, 4.00, 4, 3, '2024-10-10'),  -- 沙拉
			('P003', 6, 2, 3.00, 4, 2, '2024-10-02'),   -- 飲料
			('P004', 10, 2, 5.00, 5, 5, '2024-10-03'),  -- 披薩
			('P005', 9, 3, 3.00, 4, 2, '2024-10-11'),   -- 炸雞
			('P006', 10, 2, 5.00, 5, 5, '2024-10-06'),  -- 義大利麵
			('P007', 8, 2, 4.00, 5, 3, '2024-10-06'),   -- 甜點
			('P008', 5, 1, 5.00, 5, 5, '2024-10-07'),   -- 海鮮飯
			('P009', 6, 2, 3.00, 4, 2, '2024-10-08'),   -- 果汁
			('P001', 15, 3, 5.00, 5, 4, '2024-10-09'),  -- 牛排 (重複評分)
			('P002', 12, 3, 4.00, 4, 3, '2024-10-10'),  -- 沙拉 (重複評分)
			('P005', 5, 1, 5.00, 5, 5, '2024-10-11');   -- 炸雞 (重複評分)
-------------------------------------------------------------------------------------------------------------------------------------------
...
-----------------------獎品表-----------------------------
	CREATE TABLE Campaignprizes (
		...
		campaign_id INT NOT NULL,                  -- 活動的識別碼，FOREIGN KEY (event_id) REFERENCES Campaign(id)
